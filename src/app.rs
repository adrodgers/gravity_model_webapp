...
use egui::{
    plot::{
        Legend, Line, LineStyle, LinkedAxisGroup, Plot, PlotPoint, PlotPoints, PlotUi, Points,
        Polygon,
    },
    Color32, Key,
};
                                ...
                                GravityObject::Sphere(sphere) => {
                                    let polygon =
                                        Polygon::new(PlotPoints::from_parametric_callback(
                                            |t| {
                                                (
                                                    sphere.x_centroid + t.sin(),
                                                    sphere.z_centroid + t.cos(),
                                                )
                                            },
                                            0.0..TAU,
                                            100,
